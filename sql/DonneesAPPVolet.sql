...
>>>>>>> eb6cb4d59283ef9ae3c6447c213435fc5a5bfc96

/* INSERTION DES QUESTIONS */

INSERT INTO AppVolet_Quizz
VALUES(1,"Quand sont apparus les premiers volets ?","Moyen Age","Antiquite","Age du fer","Age du Bronze");
/*---------------------------------------------------------------*/
INSERT INTO AppVolet_Quizz
VALUES(2,"Quelle était la matière des 1er volets ? ","Bois","Tissu","Aluminium","PVC");
/*---------------------------------------------------------------*/
INSERT INTO AppVolet_Quizz
VALUES(3,"Durant quel siècle les volets ont-ils évolué en volet formé de bois et de métal ?","21eme siecle","18eme siecle","19eme siecle","20eme siecle");
/*---------------------------------------------------------------*/
INSERT INTO AppVolet_Quizz
VALUES(4,"Pourcentage de gain thermique lié au volets ?","30%","25%","50%","60%");
/*---------------------------------------------------------------*/
INSERT INTO AppVolet_Quizz
VALUES(5,"Quel est le 1er avantage de l’automatisation et de la motorisation des volets ?","La securite","L automatisation","Le confort","Le prix");
/*---------------------------------------------------------------*/
INSERT INTO AppVolet_Quizz
VALUES(6,"Quel matériau donne le plus d’avantages pour un volet ?","Le Bois","Le PVC","Le Fer","L aluminium");
/*---------------------------------------------------------------*/
INSERT INTO AppVolet_Quizz
VALUES(7,"
Quel est le prix moyen pour une installation de volet à votre domicile ?","800€","1700€","1000€","1300€");